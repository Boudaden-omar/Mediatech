...
<% DAO_Product dao = new DAO_Product();
    List<Produit> products = dao.getProducts();%>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                                    ...
                                    <i class="typcn typcn-archive icon-xl text-secondary"></i>
                ...
                <form action="RechercheProduitServlet" method="get" class="search-form">
                    <input type="text" id="keyword" name="keyword" class="search-input" placeholder="Entrez un mot-clé">
                    <button type="submit" class="search-button">Rechercher</button>
                </form>
                <a href="AjouterProduit.jsp">
                    <button type="submit" class="btn btn-success btn-sm  btn-sm btn-icon-text">
                        Ajouter
                        <i class="typcn typcn-user-add-outline btn-icon-append"></i>
                    </button>
                </a>
                <a href="demandeProduit.jsp">
                        ...
                        <div class="card">
                            <div class="table-responsive pt-3">
                                <table class="table table-striped project-orders-table">
                                    ...
                                    %>
                                    <tr>
                                        <td><%= product.getID_PROD()%>
                                        </td>
                                        <td><%= product.getDESIGNATION()%>
                                        </td>
                                        <td>$<%= product.getPRIX() %>
                                        </td>
                                        <%
                                            if(product.getQTE_STOCK() < 5){
                                        %>
                                        <td style="background-color: red"><%= product.getQTE_STOCK() %>
                                        </td>
                                        <%}else {%>
                                        <td><%= product.getQTE_STOCK() %>
                                        </td>
                                        <%}%>
                                        <td>
                                            <form method="post" action="updateProduit.jsp">
                                                <input type="hidden" name="idproduit" value="<%=product.getID_PROD()%>">
                                                <button type="submit"
                                            ...
                                            <!--<form method="post" action="deletProduitServlet">
