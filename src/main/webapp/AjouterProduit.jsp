                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="ajouterProduit" method="post"
                                      enctype="multipart/form-data">
                                   <!-- <div class="form-group">
                                        <label for="exampleInputName1">ID Produit</label>
                                        <input type="number" class="form-control" id="exampleInputName1" name="IdProd" required>
                                    </div> -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword4">Quantity Stock</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control"
                                                   aria-label="Amount (to the nearest dollar)" name="prix" required>
