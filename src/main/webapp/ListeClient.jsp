                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <form method="post" action="UpdateClient.jsp">
                                                <input type="hidden" name="clientId" value="<%= client.getId_clt()%>">
                                                <button type="submit" class="btn btn-success btn-sm  btn-sm btn-icon-text" style="height: 100%">
                                                    Éditer
                                    ...
                                    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Select "Delet" below if you wante to delet this Client.</div>
