                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="updateClientServlet" method="post"
                                >
                                    <div class="form-group">
                                        <label >ID Client</label>
                                        <input type="number" class="form-control" id="idclt" name="idclt" value="<%=client.getId_clt()%>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label >Nom</label>
                                    ...
                                    <label >PreNom</label>
                                    <input type="text" class="form-control" value="<%=client.getPrenom()%>" id="prenom"
                                           name="prenom" required>
                                </div>

                                    <div class="form-group">
                                        <label>Tel</label>
                                        <input type="number" class="form-control" id="Tel" name="tel" value="<%=client.getTel()%>" required>
                                    </div>
